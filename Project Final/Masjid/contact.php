...
<head>
    ...
    <link href="kegiatan.css" rel="stylesheet">
</head>
    ...
    <div class="row" style="text-align: center;">
        <div class="col ">
            <div class="card" style="width: 18rem;">
                <img src="img/azka.jpg" alt="" class="rounded">
                <div class="card-body">
                    <p class="card-text">Azka Permadi</p>
                    <p class="card-text">086243623824</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card justify-content-center" style="width: 18rem;">
                <img src="img/syahrul.jpg" alt="" class="rounded">
                <div class="card-body">
                    <p class="card-text">Syahrul</p>
                    <p class="card-text">086243623824</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card" style="width: 18rem;">
                <img src="img/zacky.jpg" alt="" class="rounded" >
                <div class="card-body">
                    <p class="card-text">Zacky</p>
                    <p class="card-text">086243623824</p>
                </div>
            </div>
        </div>
