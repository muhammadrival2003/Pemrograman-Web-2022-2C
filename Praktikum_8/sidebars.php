...
<body>
  ...
  <main class="d-flex flex-nowrap">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark fixed-top" style="width: 280px; top:55px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
          <a href="index.php?x=1" class="nav-link <?php echo $_GET['x']==1 ? 'active' : 'link-light' ?> text-white" aria-current="page">
        ...
        <li>
          <a href="dashboard.php?x=2" class="nav-link <?php echo $_GET['x']==2 ? 'active' : 'link-light' ?> text-white" aria-current="page">
            <svg class="bi pe-none me-2" width="16" height="16">
        ...
        <li>
          <a href="orders.php?x=3" class="nav-link <?php echo $_GET['x']==3 ? 'active' : 'link-light' ?> text-white" aria-current="page">
            <svg class="bi pe-none me-2" width="16" height="16">
        ...
        <li>
          <a href="products.php?x=4" class="nav-link <?php echo $_GET['x']==4 ? 'active' : 'link-light' ?> text-white" aria-current="page">
            <svg class="bi pe-none me-2" width="16" height="16">
              <use xlink:href="#grid" />
            </svg>
            Products
        ...
        <li>
          <a href="customers.php?x=5" class="nav-link <?php echo $_GET['x']==5 ? 'active' : 'link-light' ?> text-white" aria-current="page">
            <svg class="bi pe-none me-2" width="16" height="16">
